...
colspan=\"2\"><h4>Descuentos</h4></td></tr>";
        ...
        $this->prestamo != 0.0 && $tabla .= "<tr><td>Descuento por prestamo: </td>";
        $this->prestamo != 0.0 && $tabla .= "<td>$ " . number_format($this->prestamo, 2, '.', ',') . "</td></tr>";

        $tabla .= "<tr><td>Total descuentos: </td>";
        $tabla .= "<td>$ " . number_format(
            $this->isss + $this->afp + $this->renta + $this->prestamo,
            2,
            '.',
            ','
        ) . "</td></tr>";
