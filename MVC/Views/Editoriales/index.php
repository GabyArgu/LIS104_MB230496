                    ...
                    <tbody>
                        <?php foreach($editoriales as $editorial): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="Editoriales/update/<?= $editorial['codigo_editorial'] ?>">Editar</a>
                                    <a class="btn btn-danger" href="Editoriales/delete/<?= $editorial['codigo_editorial'] ?>">Eliminar</a>
                                </td>
                            </tr>
