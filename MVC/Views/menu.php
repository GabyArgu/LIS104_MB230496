      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="autoresDropdown">
            <li><a class="dropdown-item" href="Autores/create">Registrar autor</a></li>
            <li><a class="dropdown-item" href="Autores">Ver lista de autores</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="editorialesDropdown">
            <li><a class="dropdown-item" href="Editoriales/create">Registrar editorial</a></li>
            <li><a class="dropdown-item" href="Editoriales">Ver lista de editoriales</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
